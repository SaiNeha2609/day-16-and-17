...
export class BankingComponent implements OnInit {
  ...
  transactions: Transaction[] = [
    ...
    { date: '2023-12-15', description: 'Deposit', amount: 500 },
    { date: '2023-12-20', description: 'Credit', amount: 1000 },
    { date: '2023-12-25', description: 'OnlinePurchase', amount: 400 },
    { date: '2023-10-30', description: 'Credit', amount: 100 },
    { date: '2023-10-30', description: 'Deposit', amount: 200 },
  ];
